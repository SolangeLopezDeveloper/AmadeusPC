...
let pageActive = 1;
const apiGetProductos = "https://amadeuspc-production.up.railway.app/api/productos";
...
const paintProductos = (productos) => {
  ...
  productos.forEach(({ id, image, name, description, price, usersFavorites }) => {
    const template = 
    `<div class="card col-12 col-md-3 card-item-product" style="width:300px; display: flex; justify-content:center">
